...
int main()
{
	...
	//unsigned int w0 = 0xfee7ce5f, w1 = 0x5ea2fb12, w2 = 0x6868cdcd, w3 = 0x3cfae8d8;
/////	unsigned int Key[] = {w0, w1, w2, w3};
	...
	//Test cho nhom 5
	//A2E7F3E9 F4EC8BB9 3217B94C 5FD982CD
	//39400A33 DB86771F 578E2089 98CDB8A4
	//thay k
	unsigned int w0 = 0xA2E7F3E9, w1 = 0xF4EC8BB9, w2 = 0x3217B94C, w3=0x5FD982CD;
	unsigned int Key[] = {w0, w1, w2, w3};
	
	//Thay M co 0x o dau ko can quan tam
	state[0] = 0x39400A33; state[1] = 0xDB86771F; state[2] = 0x578E2089; state[3] = 0x98CDB8A4;	
